...
// Last Revision : 17.06.2017 17:43
// Description   : 
#endregion
...
{
    /// <summary>
    /// Правило клеточного автомата - циклический, окрестность Мура.
    /// </summary>
    public class MooreCyclic : IRule
    {
        ...
        /// </summary>
        public string Name => Resources.Rule_MooreCyclic_Name;
        ...
        public int TransformCell(Field pastFiled, int x, int y, int statesCount)
        {
            ...
            foreach (int c in pastFiled.GetNeighborsInAllDirections(x, y))
                if (c == nextState)
                    return nextState;
